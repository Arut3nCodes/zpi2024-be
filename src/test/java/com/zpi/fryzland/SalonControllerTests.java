...
public class SalonControllerTests {
    ...
    public void testGetSalonByIdWithEmployeeLogin() throws Exception {
        ...
        SalonModel testSalonModel = new SalonModel(1, "Salon ABC", "+48 123456789", "Warszawa", "Marszałkowska", "10", "00-001");
        SalonDTO testSalonDTO = new SalonDTO(1, "Salon ABC", "+48 123456789", "Warszawa", "Marszałkowska", "10", "00-001");
